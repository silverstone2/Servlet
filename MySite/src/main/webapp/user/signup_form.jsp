	...
	<div class="container">
		...
		<form action="signup.jsp" method="post" id="signupForm">
			<div class="mb-3">
				...
				<small class="form-text text-muted">영문자 소문자로 시작, 5글자~10글자 이내로 입력하시오</small>
				<div class="invalid-feedback">사용할 수 없는 아이디입니다!</div>
			</div>
			<div class="mb-3">
				<label class="control-label" for="pwd">Password</label>
				<input class="form-control" type="password" name="pwd" id="pwd"/>
				<small class="form-text text-muted">특수 문자를 하나 이상 조합하시오.</small>
			...
			<button class="btn btn-outline-primary btn-sm me-2" type="submit">가입</button>
			<button class="btn btn-outline-success btn-sm me-2" type="button" onclick=location.href="/MySite/index.jsp">Home</a>
		</form>	
	</div>
	<script>
		...
		document.querySelector("#id").addEventListener("input", function(){
			...
			fetch("${pageContext.request.contextPath }/user/checkid.jsp?inputId="+inputId)
