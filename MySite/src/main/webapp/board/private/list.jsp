...
<%
	...
	//전체 글의 갯수
	int totalRow=WriteDao.getInstance().getCount();
	...
	//WriteDto 객체에 startRowNum 과 endRowNum 을 담아서 
	WriteDto dto=new WriteDto();
	dto.setStartRowNum(startRowNum);
	dto.setEndRowNum(endRowNum);
	//글 목록을 얻어온다. 
	List<WriteDto> list=WriteDao.getInstance().getList(dto);
%>    
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container">
		<h1>글 목록 입니다.</h1>
		<a href="/MySite/index.jsp">Home</a>
