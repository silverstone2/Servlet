...
<%
	...
	//전체 글의 갯수
	int totalRow=UploadDao.getInstance().getCount();
	...
	//파일 목록을 select 해 온다. 
	List<UploadDto> list=UploadDao.getInstance().getList(dto);
...
<body>
	<div class="container">
		<h1>자료실 목록 입니다.</h1>
		<a href="/Step04_Final/index.jsp">Home</a>
